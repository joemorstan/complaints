    ...
    <div class="col-md-6 offset-md-3">
        ...
        <div class="card card-outline-secondary">
            <div class="card-header">
                <h3 class="mb-0">Edit proposition</h3>
            </div>
            <div class="card-block">
                ...
                <form action="<?= URL ?>propositions/update" id="propositionEditForm" method="post" class="form" role="form" autocomplete="off">
                    ...
                    <fieldset>
                        ...
                        <div class="row mb-1">
                            <div class="col-lg-12">
                                <input type="url" name="url" id="urlInput" class="form-control" value="<?= $data->url ?>">
                            </div>
                        </div>
